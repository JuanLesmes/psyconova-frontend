 ...
 * publicado y lo sirve, con codigo 404 de verdad, para cualquier direccion que
 * no corresponda a un archivo. Angular prerenderiza la ruta /404 como
 * `404/index.html`, que no es ese nombre: sin esta copia, Netlify responderia
 * con su 404 generico, sin la marca ni las lineas de crisis. `404/index.html`
 * se conserva para que /404 escrito a mano siga funcionando. Corre en el `postbuild`.
 */
